...
image1 = 'image2.jpeg'
imageTest1 = '20241119-_RVB1178 – lille.jpeg'
imageTest2 = '20241119-_RVB1178 – mellem.jpeg'
imageTest3 = '20241119-_RVB1178 – stor.jpeg'

img = Image.open(imageTest2)
im = cv2.imread(imageTest2)
img.show()
pixel_map = img.load()
